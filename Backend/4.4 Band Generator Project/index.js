...
app.post("/submit", (req, res) => {
  ...
  var nounIndex = Math.floor(Math.random() * adj.length);

  var adjSelected = adj[adjIndex];
  var nounSelected = noun[nounIndex];

  res.render("index.ejs", { randomAdj : adjSelected, randomNoun: nounSelected });
});
